...
public class MovePlayer : MonoBehaviour
{
    ...
    [SerializeField] private static MovementSettings m_GroundSettings = new MovementSettings(7, 14, 10);
    [SerializeField] private static MovementSettings m_AirSettings = new MovementSettings(7, 2, 2);
    [SerializeField] private static MovementSettings m_StrafeSettings = new MovementSettings(1, 50, 50);

    public static float MaxGroundSpeed
    {
        get
        {
            return m_GroundSettings.MaxSpeed;
        }
        set
        {
            m_GroundSettings.MaxSpeed = value;
        }
    }
    public static float MaxAirSpeed
    {
        get
        {
            return m_AirSettings.MaxSpeed;
        }
        set
        {
            m_AirSettings.MaxSpeed = value;
        }
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            Vector3 jumpDirection = new Vector3(m_Character.velocity.magnitude, 10);
            m_Character.Move(jumpDirection);
        }
    }
}
